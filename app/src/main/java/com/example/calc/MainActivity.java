...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btnAC, btnDel, btnDivision, btnMultiplication, btnSubtraction, btnAddition, btnEqual, btnDot;
    ...
    public void backspace(){
        //if curr is not empty then remove last char
        if(!curr.isEmpty()){
            ...
            //if the operator is detected => delete three digits or chars from the curr and set operator_inserted = false
            if (curr.substring(curr.length()-1, curr.length()).equals(" ")){
